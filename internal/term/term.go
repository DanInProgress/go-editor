...
// Package term is a trimmed copy of k8s.io/kubectl/pkg/util/term containing
// only the TTY state handling required to launch an editor. The terminal
// resizing support and the printers-based terminal detection helpers of the
// original package are omitted, as they are not used here and would pull in
// k8s.io/cli-runtime and k8s.io/apimachinery.
package term
...
import (
	...
	"github.com/DanInProgress/go-editor/internal/interrupt"
)
...
type TTY struct {
	...
	In io.Reader
	// Out is a writer representing stdout. It is an optional field.
	Out io.Writer
